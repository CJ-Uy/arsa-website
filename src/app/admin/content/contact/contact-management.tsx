...
export function ContactManagement({ initialContent }: ContactManagementProps) {
	...
	const handleSave = async () => {
		setSaving(true);
		try {
			const result = await saveSiteContent("page-contact", content);
			if (result.success) {
			...
			<div className="mb-6 flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground text-sm">
						Edit the content displayed on the Contact page
					</p>
				</div>
