		...
		<div className="min-h-screen">
			...
			<section className="relative py-24">
				...
				<div className="relative mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
					<h1 className="mb-6 text-5xl font-bold text-white drop-shadow-lg">ARSA Calendar</h1>
					<p className="mx-auto max-w-3xl text-xl font-medium text-white drop-shadow-md">
						Stay updated with all the events, activities, and important dates happening around the
						dorm.
					</p>
				</div>
			</section>
				...
				<div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
					...
					<div className="pt-8 text-center">
						<p className="text-muted-foreground">
							Events are updated regularly. For questions, contact your RA or check the ARSA
							Facebook page.
						</p>
					</div>
				</div>
